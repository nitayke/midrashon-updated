...
export default function CustomSelect({ options, value, onChange, placeholder = "בחרי...", required = false }) {
  ...
  return (
    <div className="custom-select-container" ref={containerRef}>
      ...
      >
        ...
        <ChevronDown style={{ width: 18, height: 18, transition: 'transform 0.2s', transform: isOpen ? 'rotate(180deg)' : 'none', color: '#881337' }} />
      </button>
